...
<div class="complaint-details">
            ...
            <div class="complaints-flex">
                ...
                <?php
                  ...
                  $query="SELECT * FROM `assigned-complaint`  where drivername='$username'";
                     ...
                     while($row = mysqli_fetch_array($query_run))
                    {
                        ?>
                         <div class="c-card">
                            ...
                            <p><input type="submit" name="task-done" value="DONE" class="btn btn-primary" style="margin-top:5px;background-color: rgb(5, 14, 254) ;color:white;border:1px solid skyblue; box-shadow:0 0 5px skyblue;"></p>
                            </form>
                       </div>
                            <?php
         //   echo $row['username'];
