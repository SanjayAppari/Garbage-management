...
<!-- registration form starting-->
    ...
    <div class="registration-main">
        <div class="registration-div col-lg-4 col-11">
            <center>
            <p class="heading-form">REGISTRATION FOR ADMIN</p>
            <form action="" method="POST">
             ...
             <div class="row">
                ...
                <input  type="submit"  name="Registration-admin" class="mybtn"  value="SUBMIT">
                </div>
             </div>
            </form>
            <br>
            <p>Already have an Admin Account ? Click Here To <a href="login-admin.php">Log In</a></p>
        </center>
        </div>
    </div>
...
<?php
    ...
    if(isset($_POST['Registration-admin'])){
        // echo"ki";
        $fname=$_POST['fname'];
        ...
        if($password!=$cpassword){
            ...
            $sql="select * from `register-admin` where (username='$username' or email= '$email');";
            ...
            if(mysqli_num_rows($res) > 0){
                ...
                $query= "insert into `register-admin` (fname,username,email,password,phnum) values ('$fname','$username','$email','$password','$phnum')";
