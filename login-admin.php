...
<!-- login form starting  -->
    <div class="login-main">
        <div class="registration-div col-lg-4 col-11">
            <center>
                <p class="heading-form">LOGIN FOR ADMIN</p>
                <form action="login-admin-process.php" method="POST">
                   ...
                   <div class="row">
                      <div class="registration-form-col1 col-lg-10 col-12">
                          <input type="submit" name="login-admin" value="SUBMIT" class="mybtn">
                      </div>
                   </div>
                  </form>
                  <br>
                  <p>Don't have an Admin Account ? Click Here To <a href="Registration-admin.php">Register</a></p>
              </center>
        </div>
    </div>
<!-- login form ending  -->
