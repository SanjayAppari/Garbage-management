...
<!-- registration form starting-->
    ...
    <div class="registration-main">
        <div class="registration-div col-lg-4 col-11">
            <center>
            <p class="heading-form">REGISTRATION FOR USER</p>
            <form action="" method="POST">
             ...
             <div class="row">
                <div class="registration-form-col1 col-lg-10 col-12">
                    <input  type="submit"  name="Registration-user" class="mybtn"  value="SUBMIT">
                </div>
             </div>
            </form>
            <br>
            <p>Already have an User Account ? Click Here To <a href="login-user.php">Log In</a></p>
        </center>
        </div>
    </div>
...
<?php
    ...
    if(isset($_POST['Registration-user'])){
        ...
        if($password!=$cpassword){
            ...
            $sql="select * from `register-user` where (username='$username' or email= '$email');";
            ...
            if(mysqli_num_rows($res) > 0){
                ...
                $query= "insert into `register-user` (fname,username,email,password,phnum) values ('$fname','$username','$email','$password','$phnum')";
