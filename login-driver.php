...
<!-- login form starting  -->
    <div class="login-main">
        <div class="registration-div col-lg-4 col-11">
            <center>
                <p class="heading-form">LOGIN FOR DRIVER</p>
                <form action="login-driver-process.php" method="POST">
                   ...
                   <div class="row">
                      ...
                      <input type="submit" name="login-driver" value="SUBMIT" class="mybtn">
                      </div>
                   </div>
                  </form>
                  <br>
                  <p>Don't have an Driver Account ? Click Here To <a href="Registration-driver.php">Register</a></p>
              </center>
        </div>
    </div>
<!-- login form ending  -->
